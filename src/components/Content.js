...
const sample = {
    class:[ // 강의 제목 , 교수이름, 내용, 작성일자, 게시글 id
        ...
        {className:"대포 포물선 감성학",proName:"김수한무",comment:"포물선이 이렇게 감성이 있었다니, 마치 대포를 거칠게 날리던 후크선장이 된 듯 마음이 따스해졌습니다", createdAt:"20161027T171340Z", id:"22"},
        {className:"주량 성장 개론",proName:"김가나", comment:"알쓰였는데 이 강의를 듣고 괴물이 되었습니다", createdAt:"20161027T171340Z", id:"31" },
        {className:"알고리즘을 알고알고",proName:"박한별", comment:"알고있나 알고리즘? 알고이쓰", createdAt:"20161027T171340Z", id:"5" }
    ],
